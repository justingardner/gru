% JobDestination
%
% JobDestination Properties:
%    type 
%    id   
%
% JobDestination Methods:
%    toJson - Convert the object to a Map that can be encoded to json
%    struct - Convert the object to a struct
    classdef JobDestination < flywheel.ModelBase
    ...
    methods
        function obj = JobDestination(varargin)
            obj@flywheel.ModelBase(flywheel.model.JobDestination.propertyMap);
    ...
    methods(Static)
        function obj = fromJson(json, context)
            obj =  flywheel.model.JobDestination;
        ...
        function obj = ensureIsInstance(obj)
            if ~isempty(obj)
                ...
                if ~isa(obj, 'flywheel.model.JobDestination')
                    obj = flywheel.model.JobDestination(obj);
                end
                if isKey(obj.props_, 'type')
                end
                if isKey(obj.props_, 'id')
