% DownloadTicket - A ticket for non-authenticated download of files
%
% DownloadTicket Properties:
%    ticket  - The ticket to use to perform the actual download
%
% DownloadTicket Methods:
%    toJson - Convert the object to a Map that can be encoded to json
%    struct - Convert the object to a struct
    classdef DownloadTicket < flywheel.ModelBase
    ...
    methods
        function obj = DownloadTicket(varargin)
            obj@flywheel.ModelBase(flywheel.model.DownloadTicket.propertyMap);
    ...
    methods(Static)
        function obj = fromJson(json, context)
            obj =  flywheel.model.DownloadTicket;
        ...
        function obj = ensureIsInstance(obj)
            if ~isempty(obj)
                ...
                if ~isa(obj, 'flywheel.model.DownloadTicket')
                    obj = flywheel.model.DownloadTicket(obj);
                end
                if isKey(obj.props_, 'ticket')
                end
            end
