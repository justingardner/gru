...
%    struct - Convert the object to a struct
    classdef JobOrigin < flywheel.ModelBase
    ...
    methods
        function obj = JobOrigin(varargin)
            obj@flywheel.ModelBase(flywheel.model.JobOrigin.propertyMap);
    ...
    methods(Static)
        ...
        function obj = ensureIsInstance(obj)
            if ~isempty(obj)
                ...
                if ~isa(obj, 'flywheel.model.JobOrigin')
                    obj = flywheel.model.JobOrigin(obj);
                end
                if isKey(obj.props_, 'type')
                end
                if isKey(obj.props_, 'id')
