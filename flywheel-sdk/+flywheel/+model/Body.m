...
%    struct - Convert the object to a struct
    classdef Body < flywheel.ModelBase
    ...
    methods
        function obj = Body(varargin)
            obj@flywheel.ModelBase(flywheel.model.Body.propertyMap);
    ...
    methods(Static)
        ...
        function obj = ensureIsInstance(obj)
            if ~isempty(obj)
                ...
                if ~isa(obj, 'flywheel.model.Body')
                    obj = flywheel.model.Body(obj);
                end
                if isKey(obj.props_, 'first_name')
                end
                if isKey(obj.props_, 'last_name')
