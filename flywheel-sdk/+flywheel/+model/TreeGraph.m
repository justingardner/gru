...
%    struct - Convert the object to a struct
    classdef TreeGraph < flywheel.ModelBase
    ...
    methods
        function obj = TreeGraph(varargin)
            obj@flywheel.ModelBase(flywheel.model.TreeGraph.propertyMap);
    ...
    methods(Static)
        function obj = fromJson(json, context)
            ...
            if ~isempty(json)
                ...
                for i = 1:length(keys)
                    ...
                    obj.props_(name) =  flywheel.model.TreeGraphNode.fromJson(value, context);
                end
            end
        ...
        function obj = ensureIsInstance(obj)
            if ~isempty(obj)
                ...
                if ~isa(obj, 'flywheel.model.TreeGraph')
                    obj = flywheel.model.TreeGraph(obj);
                end
                propKeys = keys(obj.props_);
                for i = 1:length(propKeys)
                    key = propKeys{i};
                    obj.props_(key) =  flywheel.model.TreeGraphNode.ensureIsInstance(obj.props_(key));
                end
            end
        end
    end
