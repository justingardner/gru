...
%    struct - Convert the object to a struct
    classdef JobDetail < flywheel.ModelBase
    % NOTE: This file is auto generated by the swagger code generator program.
    % Do not edit the file manually.
    properties (Constant)
        propertyMap = containers.Map({ 'id', 'origin', 'gearId', 'gearInfo', 'parentInfo', 'previousJobId', 'inputs', 'outputs', 'destination', 'tags', 'state', 'attempt', 'created', 'modified', 'retried', 'config', 'request' }, ...
            { 'id', 'origin', 'gear_id', 'gear_info', 'parent_info', 'previous_job_id', 'inputs', 'outputs', 'destination', 'tags', 'state', 'attempt', 'created', 'modified', 'retried', 'config', 'request' });
    end
    ...
    methods
        function obj = JobDetail(varargin)
            obj@flywheel.ModelBase(flywheel.model.JobDetail.propertyMap);
    ...
    methods(Static)
        function obj = fromJson(json, context)
            ...
            if isfield(json, 'inputs')
                obj.props_('inputs') = flywheel.model.JobDetailInputsObject.fromJson(json.inputs, context);
            end
            if isfield(json, 'outputs')
                obj.props_('outputs') = flywheel.ModelBase.cellmap(@(x) flywheel.model.JobDetailFileEntry.fromJson(x, context), json.outputs);
            end
        ...
        function obj = ensureIsInstance(obj)
            if ~isempty(obj)
                ...
                if ~isa(obj, 'flywheel.model.JobDetail')
                    obj = flywheel.model.JobDetail(obj);
                end
                if isKey(obj.props_, 'id')
                end
                if isKey(obj.props_, 'origin')
                ...
                if isKey(obj.props_, 'inputs')
                    obj.props_('inputs') =  flywheel.model.JobDetailInputsObject.ensureIsInstance(obj.props_('inputs'));
                end
                if isKey(obj.props_, 'outputs')
                    obj.props_('outputs') = flywheel.ModelBase.cellmap(@flywheel.model.JobDetailFileEntry.ensureIsInstance, obj.props_('outputs'));
                end
                if isKey(obj.props_, 'destination')
