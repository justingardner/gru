% TreeResponseItem - Response varies based on selected container and fields
%
% TreeResponseItem Properties:
%
% TreeResponseItem Methods:
%    toJson - Convert the object to a Map that can be encoded to json
%    struct - Convert the object to a struct
    classdef TreeResponseItem < flywheel.ModelBase
    ...
    methods
        function obj = TreeResponseItem(varargin)
            obj@flywheel.ModelBase(flywheel.model.TreeResponseItem.propertyMap);
    ...
    methods(Static)
        function obj = fromJson(json, context)
            obj =  flywheel.model.TreeResponseItem;
            if ~isempty(json)
        ...
        function obj = ensureIsInstance(obj)
            if ~isempty(obj)
                ...
                if ~isa(obj, 'flywheel.model.TreeResponseItem')
                    obj = flywheel.model.TreeResponseItem(obj);
                end
            end
        end
    end
