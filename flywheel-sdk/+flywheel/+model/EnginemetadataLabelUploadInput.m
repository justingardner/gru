...
%
% EnginemetadataLabelUploadInput Properties:
%    group       
%    project     
%    session     
%    acquisition 
%
% EnginemetadataLabelUploadInput Methods:
%    toJson - Convert the object to a Map that can be encoded to json
%    struct - Convert the object to a struct
    classdef EnginemetadataLabelUploadInput < flywheel.ModelBase
    % NOTE: This file is auto generated by the swagger code generator program.
    % Do not edit the file manually.
    properties (Constant)
        propertyMap = containers.Map({ 'group', 'project', 'session', 'acquisition' }, ...
    ...
    methods
        function obj = EnginemetadataLabelUploadInput(varargin)
            obj@flywheel.ModelBase(flywheel.model.EnginemetadataLabelUploadInput.propertyMap);
    ...
    methods(Static)
        function obj = fromJson(json, context)
            obj =  flywheel.model.EnginemetadataLabelUploadInput;
            if isfield(json, 'group')
                obj.props_('group') = flywheel.model.GroupMetadataInput.fromJson(json.group, context);
            end
        ...
        function obj = ensureIsInstance(obj)
            if ~isempty(obj)
                ...
                if ~isa(obj, 'flywheel.model.EnginemetadataLabelUploadInput')
                    obj = flywheel.model.EnginemetadataLabelUploadInput(obj);
                end
                if isKey(obj.props_, 'group')
                    obj.props_('group') =  flywheel.model.GroupMetadataInput.ensureIsInstance(obj.props_('group'));
                end
                if isKey(obj.props_, 'project')
