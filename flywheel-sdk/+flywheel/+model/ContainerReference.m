% ContainerReference - A reference to an individual container, by type and id
%
% ContainerReference Properties:
%    type  - The type of container (e.g. session)
%    id    - Unique database ID
%
% ContainerReference Methods:
%    toJson - Convert the object to a Map that can be encoded to json
%    struct - Convert the object to a struct
    classdef ContainerReference < flywheel.ModelBase
    ...
    methods
        function obj = ContainerReference(varargin)
            obj@flywheel.ModelBase(flywheel.model.ContainerReference.propertyMap);
    ...
    methods(Static)
        function obj = fromJson(json, context)
            obj =  flywheel.model.ContainerReference;
        ...
        function obj = ensureIsInstance(obj)
            if ~isempty(obj)
                ...
                if ~isa(obj, 'flywheel.model.ContainerReference')
                    obj = flywheel.model.ContainerReference(obj);
                end
                if isKey(obj.props_, 'type')
                end
                if isKey(obj.props_, 'id')
