% SearchCollectionResponse - Fields for collection search response
%
% SearchCollectionResponse Properties:
%    id       - Unique database ID
%    label    - Application-specific label
%    curator  - Database ID of a user
%    created  - Creation time (automatically set)
%
% SearchCollectionResponse Methods:
%    toJson - Convert the object to a Map that can be encoded to json
%    struct - Convert the object to a struct
    classdef SearchCollectionResponse < flywheel.ModelBase & flywheel.mixins.CollectionMixin
    % NOTE: This file is auto generated by the swagger code generator program.
    % Do not edit the file manually.
    properties (Constant)
        propertyMap = containers.Map({ 'id', 'label', 'curator', 'created' }, ...
            { '_id', 'label', 'curator', 'created' });
    end
    ...
    methods
        function obj = SearchCollectionResponse(varargin)
            obj@flywheel.ModelBase(flywheel.model.SearchCollectionResponse.propertyMap);
    ...
    methods(Static)
        function obj = fromJson(json, context)
            obj =  flywheel.model.SearchCollectionResponse;
        ...
        function obj = ensureIsInstance(obj)
            if ~isempty(obj)
                ...
                if ~isa(obj, 'flywheel.model.SearchCollectionResponse')
                    obj = flywheel.model.SearchCollectionResponse(obj);
                end
                if isKey(obj.props_, '_id')
                end
                if isKey(obj.props_, 'label')
