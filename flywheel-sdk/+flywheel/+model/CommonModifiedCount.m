% CommonModifiedCount
%
% CommonModifiedCount Properties:
%    modified 
%
% CommonModifiedCount Methods:
%    toJson - Convert the object to a Map that can be encoded to json
%    struct - Convert the object to a struct
    classdef CommonModifiedCount < flywheel.ModelBase
    ...
    methods
        function obj = CommonModifiedCount(varargin)
            obj@flywheel.ModelBase(flywheel.model.CommonModifiedCount.propertyMap);
    ...
    methods(Static)
        function obj = fromJson(json, context)
            obj =  flywheel.model.CommonModifiedCount;
        ...
        function obj = ensureIsInstance(obj)
            if ~isempty(obj)
                ...
                if ~isa(obj, 'flywheel.model.CommonModifiedCount')
                    obj = flywheel.model.CommonModifiedCount(obj);
                end
                if isKey(obj.props_, 'modified')
                end
            end
