...
%
% EnginemetadataUidUploadInput Properties:
%    group       
%    project     
%    session     
%    acquisition 
%
% EnginemetadataUidUploadInput Methods:
%    toJson - Convert the object to a Map that can be encoded to json
%    struct - Convert the object to a struct
    classdef EnginemetadataUidUploadInput < flywheel.ModelBase
    ...
    methods
        function obj = EnginemetadataUidUploadInput(varargin)
            obj@flywheel.ModelBase(flywheel.model.EnginemetadataUidUploadInput.propertyMap);
    ...
    methods(Static)
        function obj = fromJson(json, context)
            obj =  flywheel.model.EnginemetadataUidUploadInput;
        ...
        function obj = ensureIsInstance(obj)
            if ~isempty(obj)
                ...
                if ~isa(obj, 'flywheel.model.EnginemetadataUidUploadInput')
                    obj = flywheel.model.EnginemetadataUidUploadInput(obj);
                end
                if isKey(obj.props_, 'group')
