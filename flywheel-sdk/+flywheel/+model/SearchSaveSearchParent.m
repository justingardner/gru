...
%
% SearchSaveSearchParent Properties:
%    type 
%    id    - Unique database ID
%
% SearchSaveSearchParent Methods:
%    toJson - Convert the object to a Map that can be encoded to json
%    struct - Convert the object to a struct
    classdef SearchSaveSearchParent < flywheel.ModelBase
    ...
    methods
        function obj = SearchSaveSearchParent(varargin)
            obj@flywheel.ModelBase(flywheel.model.SearchSaveSearchParent.propertyMap);
    ...
    methods(Static)
        function obj = fromJson(json, context)
            obj =  flywheel.model.SearchSaveSearchParent;
        ...
        function obj = ensureIsInstance(obj)
            if ~isempty(obj)
                ...
                if ~isa(obj, 'flywheel.model.SearchSaveSearchParent')
                    obj = flywheel.model.SearchSaveSearchParent(obj);
                end
                if isKey(obj.props_, 'type')
                end
                if isKey(obj.props_, 'id')
