...
%
% MasterSubjectCodeIdInput Properties:
...
%
% MasterSubjectCodeIdInput Methods:
%    toJson - Convert the object to a Map that can be encoded to json
%    struct - Convert the object to a struct
    classdef MasterSubjectCodeIdInput < flywheel.ModelBase
    ...
    methods
        function obj = MasterSubjectCodeIdInput(varargin)
            obj@flywheel.ModelBase(flywheel.model.MasterSubjectCodeIdInput.propertyMap);
    ...
    methods(Static)
        function obj = fromJson(json, context)
            obj =  flywheel.model.MasterSubjectCodeIdInput;
        ...
        function obj = ensureIsInstance(obj)
            if ~isempty(obj)
                ...
                if ~isa(obj, 'flywheel.model.MasterSubjectCodeIdInput')
                    obj = flywheel.model.MasterSubjectCodeIdInput(obj);
                end
                if isKey(obj.props_, 'first_name')
                end
                if isKey(obj.props_, 'last_name')
