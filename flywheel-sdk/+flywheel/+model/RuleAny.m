...
%    struct - Convert the object to a struct
    classdef RuleAny < flywheel.ModelBase
    % NOTE: This file is auto generated by the swagger code generator program.
    % Do not edit the file manually.
    properties (Constant)
        propertyMap = containers.Map({ 'type', 'value', 'regex' }, ...
            { 'type', 'value', 'regex' });
    end
    ...
    methods
        function obj = RuleAny(varargin)
            obj@flywheel.ModelBase(flywheel.model.RuleAny.propertyMap);
    ...
    methods(Static)
        ...
        function obj = ensureIsInstance(obj)
            if ~isempty(obj)
                ...
                if ~isa(obj, 'flywheel.model.RuleAny')
                    obj = flywheel.model.RuleAny(obj);
                end
                if isKey(obj.props_, 'type')
                end
                if isKey(obj.props_, 'value')
