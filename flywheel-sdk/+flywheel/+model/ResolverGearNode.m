...
%
% ResolverGearNode Methods:
%    toJson - Convert the object to a Map that can be encoded to json
%    struct - Convert the object to a struct
    classdef ResolverGearNode < flywheel.ModelBase & flywheel.mixins.GearMixin
    ...
    methods
        function obj = ResolverGearNode(varargin)
            obj@flywheel.ModelBase(flywheel.model.ResolverGearNode.propertyMap);
    ...
    methods(Static)
        function obj = fromJson(json, context)
            obj =  flywheel.model.ResolverGearNode;
        ...
        function obj = ensureIsInstance(obj)
            if ~isempty(obj)
                ...
                if ~isa(obj, 'flywheel.model.ResolverGearNode')
                    obj = flywheel.model.ResolverGearNode(obj);
                end
                if isKey(obj.props_, '_id')
                end
                if isKey(obj.props_, 'category')
