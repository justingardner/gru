...
%    struct - Convert the object to a struct
    ...
    properties (Constant)
        propertyMap = containers.Map({ 'id', 'inputs', 'files', 'job', 'gearInfo', 'notes', 'description', 'label', 'parent', 'parents', 'created', 'modified', 'revision' }, ...
            { '_id', 'inputs', 'files', 'job', 'gear_info', 'notes', 'description', 'label', 'parent', 'parents', 'created', 'modified', 'revision' });
    end
