% gruImportSurfaceOFF.m
%
%      usage: v = gruImportSurfaceOFF
...
%
%    base = importSurfaceOFF('/path/to/surfaces/subject_left_WM.off','bothHemiFlag','/path/to/canonical/SID.nii');
%    viewSet(getMLRView, 'newbase', base);

function base = gruImportSurfaceOFF(pathStr,bothHemiFlag,pathCanon)
