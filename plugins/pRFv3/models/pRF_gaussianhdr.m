...
%         by: akshay jagadeesh
%       date: 09/02/16
%    purpose: Gaussian pRF model with fitted hemodynamic-response parameters.
%
...
if strcmp(varargin{1}, 'getModelResponse')
  ...
  thisModelResponse = pRFProjectStimulus(rfModel,fitParams.stim{i},nFrames);
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%pRF_gaussianhdr('setParams', fitParams)%%%%%
