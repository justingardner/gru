...
%
%        $Id:$ 
%      usage: pRF_diffGaussian(varargin)
%         by: akshay jagadeesh
%       date: 09/02/16
%    purpose: Difference-of-Gaussians pRF model.
%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%% pRF_diffGaussian('getModelResponse', fitParams, rfModel, hrf, p, i) %%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%% pRF_diffGaussian('setParams', fitParams) %%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%  pRF_diffGaussian(command, fitParams, params)  %%%%%
