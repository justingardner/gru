...
[fitparams resnorm residual exitflag output lambda jacobian] = lsqnonlin(@sigmoiderr,initparams,minfit,maxfit,optimset('LevenbergMarquardt','on','MaxIter',maxiter),contrasts,responses);
