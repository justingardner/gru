...
%% Scan 1 (BarsTask)
mglRetinotopy('displayName=fMRIprojFlex','barsTask=1','fixedRandom=1','stimulusPeriod=24','stepsPerCycle',48,'blanks=3','doEyeCalib=0');

%% Scan 2 (BarsTaskFixation)
mglRetinotopy('displayName=fMRIprojFlex','barsFix=1','fixedRandom=1','stimulusPeriod=24','stepsPerCycle',48,'blanks=3','doEyeCalib=0');
