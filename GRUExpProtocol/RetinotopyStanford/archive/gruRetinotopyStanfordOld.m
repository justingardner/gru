...
%% expanding rings
mglRetinotopy('displayName=fMRIproj32','rings=1','direction=1','numCycles496  no fo=10','stimulusPeriod=24','stepsPerCycle',48,'doEyeCalib=0','initialHalfCycle=0');
